...
export default function Register() {
  const [form, setForm] = useState({ firstName:'', lastName:'', email:'', 'bot-field':'' })
  ...
  return (
    <main className="section">
      <div className="container">
        ...
        <form name="register" method="POST" data-netlify="true" netlify-honeypot="bot-field" onSubmit={handleSubmit}>
